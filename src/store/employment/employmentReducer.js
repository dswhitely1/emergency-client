...
const employmentStart = state => ({...state, isLoading: true, employment: [], errors: null})
const employmentSuccess = (state, payload) => ({...state, isLoading: false, employment: payload, errors: null});
const addOrUpdateEmploymentSuccess = (state, payload) => ({...state, isLoading: false, employment: payload, errors: null, isSuccess: true})
const employmentFail = (state, payload) => ({...state, isLoading: false, errors: payload, isSuccess: false});
