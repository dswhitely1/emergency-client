...
function Contact() {
    const {isLoading, isSuccess, errors} = useSelector(state => state.message);
    ...
    return (
        <>
                    ...
                    <Form onSubmit={submit}>
                        ...
                        <FormRows>
                            <StyledTextField
                                ...
                                helperText={errors && 'An error has occurred, please try again later.'}
                                multiline
                                name='message'
                                id='message'
                                label='Message'
                        ...
                        <ButtonContainer form>
                            <Button color='primary' onClick={handleClose} disabled={isLoading}>Reset</Button>
                            <Button color='primary' type='submit' disabled={isLoading}>{isLoading ?
                                <Loader type='ThreeDots' color='#670300' height={20} width={20}/> : 'Submit'}</Button>
            ...
            <ConfirmDialog isSuccess={isSuccess} title='Send Message'
                           message="Your Message has successfully been submitted!" handleClose={handleClose}/>
        </>
    )
}
