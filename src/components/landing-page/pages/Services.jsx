...
import {Image, Section, StyledContainer, StyledTypography} from "../styles/customStyles";
        ...
        <Section inverted id='services'>
            ...
            <Grid container>
                ...
                <Grid item xs={12} sm={5}>
                    ...
                    <StyledTypography paragraph>Emergency Electric, Inc can assist with any type of residential renovation, whether you are building an extension to your home or installing recessed lights in your condo.</StyledTypography>
                </Grid>
                <Grid item xs={0} sm />
                <Grid item xs={12} sm={5}>
                    <Image src={commercial} alt='Residential' />
                    <StyledTypography variant='h4'>Commercial</StyledTypography>
                    <StyledTypography paragraph>Emergency Electric, Inc offers a variety of commercial services, by our commercial electrical contractors.</StyledTypography>
                </Grid>
                <Grid item xs={0} sm />
            </Grid>
